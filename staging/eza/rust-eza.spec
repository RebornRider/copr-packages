...
Source:         https://github.com/RebornRider/copr-packages/releases/download/source-artefacts/eza-0.23.4-vendor.tar.xz
...
%package     -n %{crate}
Summary:        %{summary}
# License below is the merged SPDX expression covering eza and all vendored
