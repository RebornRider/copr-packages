...
%package     -n %{crate}
Summary:        %{summary}
# License below is the merged SPDX expression covering dysk and all vendored
# crates, generated by %%cargo_license_summary. Re-run after dependency bumps
# and update if the build log reports a different expression.
