...
Source:         https://github.com/RebornRider/copr-packages/releases/download/source-artefacts/atuin-18.16.1-vendor.tar.xz
...
%package     -n %{crate}
Summary:        %{summary}
# License below is the merged SPDX expression covering atuin and all vendored
