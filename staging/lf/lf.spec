...
# ruler.default
install -m 0644 -Dvp etc/ruler.default     %{buildroot}%{_pkgdocdir}/ruler.default
...
%dir %{_pkgdocdir}
%doc %{_pkgdocdir}/*
%doc CHANGELOG.md CONTRIBUTING.md README.md doc.md
%{_mandir}/man1/%{name}.1*
%{_bindir}/%{name}
# directories provided by 'filesystem' and 'setup'
